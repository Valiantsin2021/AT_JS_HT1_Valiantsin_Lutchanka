...
describe(`Should login to ${baseUrl}, succesfully create new job, change it, delete it and logout`, () => {
    ...
    describe(`Should open ${baseUrl} and login with valid credentials`, () => {
    ...
    describe('Should perform assertions on header, side menu, profile image on the Main Page', () => {
    ...
    describe(`Should click Admin link and perform assertions on header, url, top menu of Admin Page`, () => {
    ...
    describe(`Should perform assertions on Job link in the top menu of Admin Page`, () => {
    ...
    describe(`Should navigate to Job Page and perform assertions on url, header, jobs grid`, () => {
    ...
    describe(`Should successfully create new Job Title`, () => {
    ...
    describe(`Should perform assertions on created Job Title on the Job Page`, () => {
    ...
    describe(`Should successfully modify the created Job Title`, () => {
    ...
    describe(`Should check the changed Job Title is visible on the Job Title page`, () => {
    ...
    describe(`Should successfully delete modified Job Title`, () => {
    ...
    describe(`Should successfully logout from the app`, () => {
